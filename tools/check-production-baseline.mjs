...
for (const marker of ["parseFiveHundredKickoffs", 'data-matchtime', 'data-buyendtime', 'data-homesxname', 'data-awaysxname', 'match.home === match.away', '500-jczq-matchtime', 'existing-reliable-schedule']) {
