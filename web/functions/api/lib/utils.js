...
export function rowToCase(row) {
  ...
  return {
    ...
    modelRevision: payload.modelRevision || row.model_version,
    ...
    conditionalHandicapChallengerSingleHit: payload.conditionalHandicapChallengerSingleHit ?? null,
    ...
    backtestContract: payload.backtestContract || null,
